...
This repository is my public lab for learning the Rust programming language.

My goal is to go from "Hello, World!" to building high-performance, secure, and reliable systems. This repo will contain all my notes, small projects, and solutions to exercises.

You can follow my thoughts and progress on **[X (formerly Twitter) at @_noahschroeder](https://x.com/_noahschroeder)**.
...
* **`/03-ownership-borrowing`**: My notes and exercises on tackling the borrow checker.
* *(More to come...)*
